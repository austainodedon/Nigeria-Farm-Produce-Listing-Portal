...
class SearchView(APIView):
    ...
    def post(self, request, format=None):
        ...
        queryset = queryset.filter(produce_type__iexact=produce_type)
        ...
        produce_state_type = data['produce_state_type']
        queryset = queryset.filter(produce_state_type__iexact=produce_state_type)
        ...
        queryset = queryset.filter(weight__gte=weight)
        ...
        queryset = queryset.filter(in_stock__iexact=in_stock)
