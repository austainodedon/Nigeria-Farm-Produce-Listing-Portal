# Generated by Django 3.1.1 on 2020-09-19 15:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produce_type', models.CharField(choices=[('Plant Produce', 'Plants'), ('Animal Produce', 'Animal')], default='Plant Produce', max_length=50)),
                ('price', models.IntegerField()),
                ('quantity', models.IntegerField()),
                ('weight', models.DecimalField(decimal_places=1, max_digits=2)),
                ('produce_state_type', models.CharField(choices=[('Fresh', 'Fresh'), ('Old', 'Old'), ('Perishing', 'Perishing')], default='Fresh', max_length=50)),
                ...
                ('resellar', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='resellars.resellar')),
            ],
        ),
    ]
